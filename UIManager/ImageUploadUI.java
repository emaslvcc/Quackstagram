...
public class ImageUploadUI extends UIManager {
    ...
    private void uploadAction(ActionEvent event) {
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                if (
                        imagePreviewLabel.getWidth() > 0 && imagePreviewLabel.getHeight() > 0
                ) {
    ...
    private void saveImageInfo(String imageId, String username, String bio)
        ...
        // Update the database with the image information
        UpdateDatabase.updatePosts(imageId, username, bio, timestamp);
    }
